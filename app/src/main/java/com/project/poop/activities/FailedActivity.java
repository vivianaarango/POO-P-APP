...
public class FailedActivity extends AppCompatActivity {
    ...
    private TextView failTextDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        failText = (TextView) findViewById(R.id.textFail);
        failTextDescription = (TextView) findViewById(R.id.textFailDescription);
        failText.setTypeface(custom_font_text);
        failTextDescription.setTypeface(custom_font_text);
